...
resource "kubernetes_config_map" "kubernetes_dashboard_settings" {
  ...
  data = {
    "_global" : "{\"clusterName\":\"gds-ops\",\"itemsPerPage\":25,\"labelsLimit\":3,\"logsAutoRefreshTimeInterval\":5,\"resourceAutoRefreshTimeInterval\":5,\"disableAccessDeniedNotifications\":true,\"defaultNamespace\":\"default\",\"namespaceFallbackList\":[\"default\"]}"
  }
  lifecycle {
    ignore_changes = [
      data,
